        ...
        <aside class="w-64 bg-[#111a22] border-r border-[#324d67] flex flex-col hidden md:flex h-screen shrink-0">
            <div class="h-20 flex items-center px-6 gap-3 border-b border-[#324d67]">
                ...
                <div>
                    ...
                    <p class="text-[#92adc9] text-[10px] uppercase font-black tracking-tighter">${this.role === 'admin' ? 'Fleet Director' : this.role === 'mechanic' ? 'Jefe de Taller' : 'Seguridad Interna'}</p>
                </div>
            </div>
                ...
                <header class="h-16 flex items-center justify-between px-8 bg-[#111a22] border-b border-[#324d67] z-10 shrink-0 shadow-sm">
                    ...
                    <div class="flex items-center gap-6">
                        <div class="relative hidden lg:block w-72">
                            ...
                            <input class="bg-[#1c2127] border border-[#324d67] text-white text-xs rounded-full focus:ring-1 focus:ring-primary focus:border-primary block w-full pl-10 p-2 placeholder-slate-500 outline-none transition-all" placeholder="Buscar unidad, conductor, producto..." type="text">
                        </div>
                        ...
                        <div class="flex items-center gap-3 pl-4 border-l border-[#324d67]">
                            <div class="flex flex-col text-right hidden sm:block">
                                ...
                                <p class="text-[#92adc9] text-[10px] flex items-center justify-end gap-1"><span class="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"></span> En línea</p>
                            </div>
